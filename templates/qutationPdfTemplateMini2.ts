...
const qutationPdfTemplateMini2 = () => {
  const {
    id,
    date,
    customerName,
  ...
  const generateWarranty = (itemWarranty: number, itemWarrantyType: string) => {
    ...
    if (itemWarranty === 1 && itemWarrantyType === "months") {
      return ` - ${itemWarranty} month warranty`;
    }
    if (itemWarranty === 1 && itemWarrantyType === "years") {
      return ` - ${itemWarranty} year warranty`;
    }
    return ` - ${itemWarranty} ${itemWarrantyType} warranty`;
  };
...
.termsTitle {
  ...
  <body>
    <div class="container">
      <div class="header">
        <img src="https://firebasestorage.googleapis.com/v0/b/quotations-5b750.appspot.com/o/CoverTop.png?alt=media&token=6555e79b-a9b3-476c-8512-831305e49388" alt="Header Image">
      </div>
      <div class="details">
      ...
      <table>
        ...
        <tbody>
            ...
            ?.map((item, index) => {
              return `
                <tr>
                  ...
                  <td colspan="3">${nameAndQuantity(
                    item?.itemName,
                    item?.itemQuantity
                  )} ${
                item.itemWarranty
                  ? generateWarranty(item.itemWarranty, item.itemWarrantyType)
                  : ""
              }
                    </td>
                </tr>
          ...
          <tr class="totalRow">
            ...
            <td class="boldText" style="width:150px;">Advance Payment</td>
            <td class="boldText">${
          ...
          <tr class="totalRow">
            <td style="width:30px;"></td>
            <td class="boldText" style="width:150px;">Total</td>
...
export default qutationPdfTemplateMini2;
